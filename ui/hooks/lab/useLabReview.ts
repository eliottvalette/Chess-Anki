...
export function useLabReview(
  ...
  const playToHistoryIndex = useCallback(async (
    targetIndex: number,
  ...
  }, [activeDeckCard?.side, historyIndex, initialFen, jumpToIndex, moveHistory, orientation, playSoundSequence, reviewPlaybackRequestIdRef, reviewPlayerSide, setGame, setHistoryIndex]);
