...
export function useLabOrchestrator() {
  ...
  const linesHasNextLearnBranch = useMemo(() => {
    ...
    return hasRemainingLearnBranches(
      learnTree,
  ...
  const getLinesStudyDebugSnapshot = useCallback(() => {
    return buildLinesStudyDebugSnapshot({
      ...
      drillPath: [...drillPathRef.current],
      drillPathIndex: drillPathIndexRef.current,
      boardPlayAllowed: isLinesBoardPlayAllowed({
        mode: labState.mode,
        hasOpeningTree: labState.activeOpeningTree != null,
        linesStudyMode: labState.linesStudyMode,
        linesLearnBranchComplete: labState.linesLearnBranchComplete,
        deckPlaybackBusy: labState.deckPlaybackBusy,
      }),
      hasNextLearnBranch: linesHasNextLearnBranch,
    });
  }, [
    currentFen,
    drillPathIndexRef,
  ...
  return {
    ...
    linesForkCoverage,
    linesHasNextLearnBranch,
    linesStudyDebugSnapshot: getLinesStudyDebugSnapshot,
    currentFen,
    currentMoves,
    hasLoadedGame,
    isTrainCardFinished,
